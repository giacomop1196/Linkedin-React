  ...
  return (
    <>
      ...
      {results && (
        <Container
          fluid
          className="bg-light d-flex px-5 justify-content-center"
        >
                    ...
                    <Col>
                      <h4>
                        ...
                        <i
                          ...
                          style={{ fontSize: "0.8em", color: "#0a66c2" }}
                        ></i>
                      </h4>
                      <p className="text-muted">
                        Sviluppatore JAVA | PHP | Laravel | MySQL | HTML5 | CSS
                ...
                <Card className="m-4">
                  <Card.Body>
                    ...
                    <Card.Text className="text-muted">
                      Ruoli di Java, PHP Web Developer, Sviluppatore SQL,
                      Sviluppatore Javascript e Laravel Developer
                    </Card.Text>
                ...
                <Card.Body>
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <small className="text-muted">
                      <i className="bi bi-globe"></i> Solo per te
                    </small>
                  </div>
                  ...
                  <div className="d-flex mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted mb-0">
                        Cartmusic · A tempo pieno
                      </p>
                      <p className="text-muted mb-0">
                        nov 2024 - apr 2025 · 6 mesi
                      </p>
                      <p className="text-muted mb-2">Palermo · Ibrido</p>
                      <p className="mb-2">
                        Sviluppo di Web Application in PHP con framework Laravel
                        e Vue.js
                      </p>
