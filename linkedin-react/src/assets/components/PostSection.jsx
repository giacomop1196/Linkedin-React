            ...
            <div className="p-3">
              ...
              <div className="d-flex justify-content-between align-items-center text-muted mb-3">
                ...
                <a href="#" className="text-decoration-none fw-bold">
                  Più rilevanti per primi <i className="bi bi-chevron-down ms-1"></i>
                </a>
              </div>
                      ...
                      <div className="d-flex justify-content-between align-items-start mb-2">
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <div className="text-muted" style={{ fontSize: '0.85em' }}>
                              {post.createdAt.split("T")[0]} • <i className="bi bi-globe"></i>
                            </div>
                          </div>
                        </div>
                        <div className="d-flex align-items-center">
                          <Dropdown align="end">
                            ...
                            <Dropdown.Menu>
                              <Dropdown.Item href="#/action-1">Nascondi post</Dropdown.Item>
                              <Dropdown.Item href="#/action-2">Segnala</Dropdown.Item>
                            </Dropdown.Menu>
                          </Dropdown>
